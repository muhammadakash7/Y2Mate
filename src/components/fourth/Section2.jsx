...
function Section2() {
    ...
    return (
        ...
        <div className='col-md-4 text-center'>
            <span><i className="fa-solid fa-earth-africa" style={iconStyle}></i></span>
        ...
        <div className='col-md-4 text-center'>
            <span><i className="fa-solid fa-share-from-square" style={iconStyle}></i></span>
        ...
        <div className='col-md-4 text-center'>
            <span><i className="fa-solid fa-h" style={iconStyle}> </i> </span>
        ...
        <div className='col-md-4 text-center'>
            <span> <i className="fa-regular fa-hand-point-up" style={iconStyle}></i></span>
        ...
        <div className='col-md-4 text-center'>
            <span><i className="fa-sharp fa-solid fa-check-double" style={iconStyle}></i></span>
