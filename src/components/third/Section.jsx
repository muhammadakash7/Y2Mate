...
function Home(props) {
  ...
  return (
    ...
    <div className="container">
      <div className="row"> 
          <h2 className="mt-3 mb-3" style={{textAlign: "center"}}> Best Youtube Video Conveter To MP4 </h2>
   ...
   <div className="container"> 
        ...
        <div className='col-md-4 text-center'>
            <span><i className="fa-solid fa-gauge" style={iconStyle}></i></span>
        ...
        <div className='col-md-4 text-center'>
            <span><i className="fa-solid fa-calendar-check" style={iconStyle}> </i> </span>
        ...
        <div className='col-md-4 text-center'>
            <span><i className="fa-solid fa-gift" style={iconStyle}></i></span>
        ...
        <div className='col-md-4 text-center'>
            <span><i className="fa-solid fa-circle-minus" style={iconStyle}> </i> </span>
        ...
        <div className='col-md-4 text-center'>
            <span> <i className="fa-solid fa-square-h" style={iconStyle}></i></span>
        ...
        <div className='col-md-4 text-center'>
            <span><i className="fa-sharp fa-solid fa-play" style={iconStyle}></i></span>
